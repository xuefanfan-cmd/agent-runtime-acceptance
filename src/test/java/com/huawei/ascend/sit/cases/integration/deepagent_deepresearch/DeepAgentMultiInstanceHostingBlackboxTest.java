...
import com.huawei.ascend.sit.cases.integration.react_travel.MultiInstanceHostingBlackboxSupport;
...
class DeepAgentMultiInstanceHostingBlackboxTest extends BaseManagedStackTest {
    ...
    private MultiInstanceHostingBlackboxSupport driver() {
        return new MultiInstanceHostingBlackboxSupport(config, stack, HOSTED_AGENT, "deep-research", "DEEP",
                "HOSTED_DEEP_AGENT_A", "HOSTED_DEEP_AGENT_B", model,
                "openjiuwen.demo.deep-research");
    }

    @Test
    @Tag("story-feat-037-t01")
    @Story("FEAT-037.T01: 双实例注册与目录")
    @DisplayName("FEAT-037 T01 DeepAgent 双实例注册并发布目录")
    ...
    @DisplayName("FEAT-037 T02 DeepAgent 非法实例名使进程启动失败")
    ...
    @DisplayName("FEAT-037 T03 DeepAgent 重复实例名快速失败")
    ...
    @DisplayName("FEAT-037 T04 DeepAgent 部分装配失败时整体回滚")
    ...
    @DisplayName("FEAT-037 T05 DeepAgent 默认取首项且允许显式覆盖")
    ...
    @DisplayName("FEAT-037 T06 DeepAgent 实例 Card 指向对应实例入口")
    ...
    @DisplayName("FEAT-037 T07 DeepAgent 未知实例 Card 返回 404")
    ...
    @DisplayName("FEAT-037 T08 DeepAgent 同步请求按实例路径隔离路由")
    ...
    @DisplayName("FEAT-037 T09 DeepAgent 流式请求按实例路径隔离路由")
    ...
    @DisplayName("FEAT-037 T10 DeepAgent GetTask 仅对归属实例可见")
    ...
    @DisplayName("FEAT-037 T11 DeepAgent SubscribeToTask 仅对归属实例可见")
    ...
    @DisplayName("FEAT-037 T13 DeepAgent 根 A2A 同步和流式请求路由到默认实例")
    ...
    @DisplayName("FEAT-037 T14 DeepAgent REST 入口支持默认和显式实例选择")
    ...
    @DisplayName("FEAT-037 T15 DeepAgent 未知实例返回明确错误且不列出可用实例")
    ...
    @DisplayName("FEAT-037 T16 DeepAgent metadata 不能覆盖入口选择的实例")
    ...
    @DisplayName("FEAT-037 T17 DeepAgent A2A 保持原响应格式且不注入托管身份")
    ...
    @DisplayName("FEAT-037 T18 DeepAgent 相同会话标识在实例间保持内存隔离")
    ...
    @DisplayName("FEAT-037 T19 DeepAgent 相同会话标识的流式历史保持隔离")
    ...
    @DisplayName("FEAT-037 T20 DeepAgent 相同会话标识的异步任务保持归属隔离")
    ...
    @DisplayName("FEAT-037 T21 DeepAgent Redis 重启恢复后同步会话保持实例隔离")
    ...
    @DisplayName("FEAT-037 T22 DeepAgent Redis 重启恢复后流式会话保持实例隔离")
    ...
    @DisplayName("FEAT-037 T23 DeepAgent Redis 重启恢复后任务保持实例归属")
    ...
    @DisplayName("FEAT-037 T25 DeepAgent 每个托管实例各启动和停止一次")
    ...
    @DisplayName("FEAT-037 T26 DeepAgent 同名会话 reset 后保持目标实例路由")
    ...
    @DisplayName("FEAT-037 T27 DeepAgent 两个实例共享进程级并发额度")
    ...
    @DisplayName("FEAT-037 T28 单实例 DeepAgent 的 Card、同步和流式入口保持兼容")
    ...
    @DisplayName("FEAT-037 T29 DeepAgent 影子任务保持托管实例归属")
    ...
    @DisplayName("FEAT-037 T30 DeepAgent 错误实例访问返回既有 TaskNotFound 且不跨实例搜索")
    ...
    @DisplayName("FEAT-037 T31 DeepAgent 无参数查询汇总两个实例的活动任务")
    ...
    @DisplayName("FEAT-037 T32 DeepAgent agentId 仅返回目标实例任务且保留进程额度")
    ...
    @DisplayName("FEAT-037 T33 DeepAgent 已注册空闲实例返回 200 和空任务列表")
    ...
    @DisplayName("FEAT-037 T34 DeepAgent 空或空白 agentId 返回 400")
    ...
    @DisplayName("FEAT-037 T35 DeepAgent 未知 agentId 返回 404 且不回退")
