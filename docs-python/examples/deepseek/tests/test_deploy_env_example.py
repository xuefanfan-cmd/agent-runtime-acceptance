...
CONFIGURATION_DOC = ROOT.parents[1] / "how-to" / "config-driven-agent.md"
...
def test_configuration_doc_leaves_decryptor_empty() -> None:
    """空解密器必须绑定为空字符串，不能让 YAML null 变成字符串 None。"""
    ...
    assert service["credential"]["decryptor"] == ""
