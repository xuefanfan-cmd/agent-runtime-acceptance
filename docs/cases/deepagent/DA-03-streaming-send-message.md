...
| 项 | 值 |
|----|----|
| 测试类 | [src/test/java/com/huawei/ascend/sit/cases/deepagent/StreamingSendMessageTest.java](../../../src/test/java/com/huawei/ascend/sit/cases/deepagent/StreamingSendMessageTest.java) |
